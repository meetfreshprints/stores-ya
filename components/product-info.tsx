  ...
  return (
    <div className="p-4 space-y-6">
      ...
      <div className="space-y-3">
        <Button className="w-full bg-green-500 text-white hover:bg-green-600 py-3 rounded-full text-lg font-semibold shadow-md">
        ...
        <Button className="w-full bg-blue-600 text-white hover:bg-blue-700 py-3 rounded-full text-lg font-semibold shadow-md flex items-center justify-center gap-2">
          <Lock className="w-5 h-5" /> Check Out With <span className="font-bold text-yellow-400">PayPal</span>
        </Button>
      </div>
