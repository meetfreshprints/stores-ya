...
export function RatingBreakdown() {
  ...
  return (
    <div className="p-6 rounded-xl text-center bg-transparent shadow-none border-transparent">
...
export function AddReviewSection() {
  return (
    <div className="bg-white p-6 rounded-xl text-center shadow-none">
      ...
      <Button className="w-full bg-green-500 text-green-foreground hover:bg-green-600 py-3 rounded-full text-lg font-semibold mt-6">
