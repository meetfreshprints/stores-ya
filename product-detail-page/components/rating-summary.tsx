  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md text-center max-w-md mx-auto">
      ...
      <div className="mt-8 space-y-2">
        ...
        <p className="text-sm text-gray-600">Your review will help other customers tremendously.</p>
        <div className="flex items-center justify-center gap-1 mt-2">
          {[...Array(5)].map((_, i) => (
            <Star key={i} className="w-8 h-8 text-gray-300 cursor-pointer hover:text-yellow-400 transition-colors" />
          ))}
        </div>
        <Button className="w-full bg-green-500 text-green-foreground hover:bg-green-600 py-3 rounded-lg text-lg font-semibold mt-4">
