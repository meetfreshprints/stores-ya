...
export default function CartPage() {
  ...
  const shipping = 5.0 // Example fixed shipping
        ...
        <div className="lg:col-span-1">
          <Card className="shadow-md rounded-xl">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full bg-green-500 text-green-foreground hover:bg-green-600 py-3 rounded-full text-lg font-semibold shadow-md mt-6">
                Proceed to Checkout
              </Button>
            </CardContent>
          </Card>
