    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-4 p-4">
      <div className="relative md:col-span-7 flex justify-center items-center">
        ...
        <Image
          ...
          width={600}
          height={600} // Changed height to match width for 1:1 aspect ratio
          className="w-full rounded-lg shadow-md object-cover aspect-square" // Changed object-contain to object-cover
        />
      </div>
